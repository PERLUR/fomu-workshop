...
project = 'FPGA Tomu (Fomu) Workshop'
copyright = '2019, Tomu Project Authors'
author = 'Tomu Project Authors'
...
if not on_rtd:
    html_context = {
        ...
        "github_user": "im-tomu",  # Username
        "github_repo": "fomu-workshop",  # Repo name
...
htmlhelp_basename = 'FPGATomuFomuWorkshopdoc'
...
latex_documents = [
    (master_doc, 'FPGATomuFomuWorkshop.tex', 'FPGA Tomu (Fomu) Workshop Documentation',
     'Tomu Project Authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'fpgatomufomuworkshop', 'FPGA Tomu (Fomu) Workshop Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FPGATomuFomuWorkshop', 'FPGA Tomu (Fomu) Workshop Documentation',
     author, 'FPGATomuFomuWorkshop', 'One line description of project.',
     'Miscellaneous'),
]
